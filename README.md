...
O foco principal foi desenvolver uma experiência digital acolhedora, intuitiva e informativa, capaz de transmitir confiança, empatia e esperança para os visitantes.

---

## 🎯 Objetivos

- Conscientizar sobre a importância da doação de medula óssea;
- Facilitar o acesso a informações confiáveis sobre o processo de doação;
- Incentivar o cadastro de novos doadores;
- Utilizar princípios de UX/UI Design para melhorar a experiência do usuário;
...
---
## 🔗 Acesse o Protótipo
https://www.figma.com/make/0HVGWhGoKyjAl5R3657pGw/Landing-page-for-donation-campaign?t=3y2GnHQEAfyFWqGa-1
